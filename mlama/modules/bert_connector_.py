...
from pytorch_pretrained_bert.tokenization import BertTokenizer, BertForMaskedLM, BasicTokenizer, BertModel
import numpy as np
...
class Bert(Base_Connector):
    ...
    def __init__(self, args, vocab_subset = None):
        ...
        if args.bert_model_dir is not None:
            ...
            dict_file = args.bert_model_name
            self.dict_file = dict_file
        ...
        #self.masked_bert_model = AutoModelWithLMHead.from_pretrained(bert_model_name)
